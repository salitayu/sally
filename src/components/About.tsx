        ...
        <div className="s-profile-section" id="s-about-section">
            <div className="s-about-container">
                <div className="s-about-content">
                    <h1>About Me</h1>
                    <p>Growing up, I was always intrigued by the world of technology. 
                       Every weekend, I worked as a cashier at an electronics store selling popular items at the time, including CDs/DVDs/Bluerays, computers, laptops, MP3s, digital cameras, printers and much more.
                       ...
                       On the weekends, I would try to figure out how to make my site more interactive by having a cart and sending emails.
